    ...
    <div className="flex w-full gap-4 p-4 !text-base md:px-16">
      ...
      >
        ...
        <div className="flex flex-col p-4 gap-4">
          ...
          <Card className="customCard flex w-full flex-col gap-4 lg:px-6 sm:flex-row md:p-6">
...
must match our records."
          ...
          <Card className="customCard flex w-full gap-4 lg:px-6 md:p-6">
            <div className="flex w-full flex-col gap-4">
              <div className="flex flex-col gap-4 sm:flex-row">
                <div className="sm:w-1/2">
                  <InputField
          ...
          <Card className="customCard flex flex-col lg:px-6 sm:p-6">
